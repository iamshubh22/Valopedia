...
public class raze extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.r1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.r2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.r3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.r4);
