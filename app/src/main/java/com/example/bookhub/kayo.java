...
public class kayo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.k1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.k2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.k3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.k4);
