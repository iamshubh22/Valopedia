...
public class omen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.o1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.o2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.o3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.o4);
