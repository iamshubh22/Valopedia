...
public class zeref extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zeref);
        setTitle("Valopedia->S8UL ZEREF PAGE");
    ...
    public void PAGE_FIRST(){
        ...
        Toast.makeText(zeref.this,"WELCOME BACK TO HOME PAGE",Toast.LENGTH_SHORT).show();
    }

    public void LOGIN(){
        Intent intent= new Intent(this,LoginActivity2.class);
        startActivity(intent);
        Toast.makeText(zeref.this,
                "HAVE A GOOD DAY",
