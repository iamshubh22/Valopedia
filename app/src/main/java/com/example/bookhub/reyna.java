...
public class reyna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.re1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.re2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.re3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.re4);
