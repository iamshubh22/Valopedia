...
public class skye extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.sk1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.sk2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.sk3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.sk4);
