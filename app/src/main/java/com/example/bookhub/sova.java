...
public class sova extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.so1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.so2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.so3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.so4);
