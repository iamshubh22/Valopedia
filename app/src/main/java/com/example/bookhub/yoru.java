...
public class yoru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.y1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.y2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.y3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.y4);
