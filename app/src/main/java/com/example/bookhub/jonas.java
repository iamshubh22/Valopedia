...
public class jonas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Valopedia-> AVERAGEJONAS PAGE");
    ...
    public void PAGE_FIRST(){
        ...
        Toast.makeText(jonas.this,"WELCOME BACK TO HOME PAGE",Toast.LENGTH_SHORT).show();
    }

    public void LOGIN(){
        Intent intent= new Intent(this,LOGIN.class);
        startActivity(intent);
        Toast.makeText(jonas.this,
                "HAVE A GOOD DAY",
