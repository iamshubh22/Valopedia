...
public class subroza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subroza);
        setTitle("Valopedia-> SUBROZA PAGE");
    ...
    public void PAGE_FIRST(){
        ...
        Toast.makeText(subroza.this,"WELCOME BACK TO HOME PAGE",Toast.LENGTH_SHORT).show();
    }

    public void LOGIN(){
        Intent intent= new Intent(this,LoginActivity2.class);
        startActivity(intent);
        Toast.makeText(subroza.this,
                "HAVE A GOOD DAY",
