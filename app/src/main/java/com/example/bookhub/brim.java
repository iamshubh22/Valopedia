...
public class brim extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_brim);
        setTitle("BRIMSTONE");
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.brim1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.brim2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.brim3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.brim4);
