...
public class pheo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pheo);
        setTitle("PHEONIX");
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.p1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.p2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.p3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.p4);
