...
public class breach extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.bre1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.bre2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.bre3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.bre4);
