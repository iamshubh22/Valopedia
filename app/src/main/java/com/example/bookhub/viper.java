...
public class viper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.v1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.v2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.v3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.v4);
