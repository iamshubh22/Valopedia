...
public class kill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.kj1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.kj2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.kj3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.kj4);
