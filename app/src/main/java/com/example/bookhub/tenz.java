...
public class tenz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenz);
        setTitle("Valopedia-> TENZ PAGE");
    ...
    public void PAGE_FIRST(){
        ...
        Toast.makeText(tenz.this,"WELCOME BACK TO HOME PAGE",Toast.LENGTH_SHORT).show();
    }

    public void LOGIN(){
        Intent intent= new Intent(this,LoginActivity2.class);
        startActivity(intent);
        Toast.makeText(tenz.this,
                "HAVE A GOOD DAY",
