...
public class sage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video1.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.s1);
        video2.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.s2);
        video3.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.s3);
        video4.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.s4);
